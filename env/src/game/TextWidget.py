...
class TextWidget(object):
    ...
    def __doc_text(self):
        return "The text to be displayed by the text wiidget"
    ...
    def __init__(self, text="", color=(0, 0, 0), size=32
    ...
    def draw(self, screen, background):
        ...
        if ((self.image) and (self.rect) and (self.dirty)):
            if (self.bold_rect):
                ...
                # Draw the background (added!)
            screen.blit(background, rect_return.topleft, rect_return)
            # Draw the text
